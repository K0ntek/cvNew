...
const About = () => {
    return (
        <>
            ...
            <div id='about' className="bg-zinc-950 w-[90%] mx-auto px-5 sm:px-10 rounded-[50px] h-fit py-[50px] z-[99] my-[50px]">
                ...
                <VerticalBlocks />
                    ...
                    <div className=" w-full xl:w-[80%] p-[20px] text-white xl:ml-[20%]">
                        ...
                        <MdCastForEducation className=" text-[20px] relative  sm:top-[20px]"/>
                            ...
                            <div className="text-[20px] text-justify  w-[95%] sm:w-[80%] mx-auto">
                                <p className=" font-megrim font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#996c50] to-[#692f0b]">09.2020 - obecnie</p>
                        ...
                        <FaBuromobelexperte className=" text-[20px] relative top-[20px]"/>
                            ...
                            <div className="text-[20px] text-justify w-[95%] sm:w-[80%] mx-auto">
                                <div className="w-fit ml-6">
                                    <p className=" font-megrim font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#996c50] to-[#692f0b]">09.2022 - 11.2022 </p>
                            ...
                            <div className="text-[20px] text-justify  w-[95%] sm:w-[80%] mx-auto">
                                <div className="w-fit ml-6">
                                    <p className=" font-megrim font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#996c50] to-[#692f0b]">03.2023 <span className=" font-inter font-[400]">oraz</span> 03.2024 </p>
                                    <div className=" mx-auto w-1/2 h-[3px] rounded-full bg-gradient-to-r from-black to-[#3d281b]"></div>
                                </div>
                    ...
                    <div className="w-5/6 h-1 rounded-full bg-gradient-to-r from-[#996c50] to-transparent  mx-auto mb-10"></div>
