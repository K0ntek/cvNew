    ...
    return (
        <ul className="flex fixed top-7 left-[50%] translate-x-[-50%] bg-black/70 rounded-full z-[97] py-2 px-8 h-[65px]">
            {navElements.map((element, i) => {
                return (
                    <li className="navElement text-white cursor-pointer bg-black/30 mx-3 md:mx-5 rounded-full text-[25px] md:text-[30px] group hover:text-[#966a43] hover:bg-black/10 transition-all duration-200">
